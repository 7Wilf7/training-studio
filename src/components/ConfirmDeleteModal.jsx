    ...
    <div onClick={() => setConfirmDelete(null)}
      ...
      <div onClick={e => e.stopPropagation()}
        ...
        <div style={{ display: "flex", gap: 8, justifyContent: "flex-end" }}>
          <button onClick={() => setConfirmDelete(null)} style={s.btnGhost}>{t("common.cancel")}</button>
          <button onClick={onConfirm} style={{ ...s.btn, background: "#c0392b", borderColor: "#c0392b" }}>{t("common.delete")}</button>
        </div>
      </div>
    </div>
  );
